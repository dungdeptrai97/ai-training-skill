...
**For Under-Covered Companies (few/no analyst reports):**
- Search company website (IR, news, product pages) to verify current revenue/product mix — do NOT assume product mix from outdated sources
- Download latest annual report and prospectus (if issued within 12 months) for verified segment breakdowns, as these may differ significantly from media coverage or training data
...
**REQUIRED: Forward-Looking Outlook ("➜ Outlook")**
After EVERY analysis section (beat/miss, segment, margin, guidance, debt), append a "➜ Outlook:" paragraph (2-3 sentences) projecting how identified drivers will impact next 1-2 quarters and full year. Example: "➜ Outlook: DTC momentum expected to sustain through FY25 as 50 new stores open, supporting our above-consensus FY25 revenue of $58B (+8% YoY)."
...
- **New fixed asset impact**: If company recently commissioned large capex (new plants/factories), flag that interest costs are no longer capitalized and depreciation begins immediately while capacity ramp takes 2-4 quarters — expect margin compression in early quarters post-commissioning before normalizing
