...
### Bảng mapping từ khóa → SỰ KIỆN (giữ từ v4)
...
### Bảng mapping từ khóa → VĨ MÔ / HÀNG HÓA (giữ từ v4)
...
### Bộ lọc sự kiện (Event-based) — giữ từ v4
...
#### Quy trình lọc theo sự kiện — giữ từ v4

#### ⚠️ Cảnh báo sự kiện — giữ từ v4
...
### Bộ lọc vĩ mô / hàng hóa — giữ từ v4
...
#### Template chuỗi tác động — giữ từ v4
...
### Ví dụ 1-8: giữ từ v4 (cập nhật thêm cột Historical Percentile và Flag khi cần)

### Ví dụ 9 — [v5 MỚI] Breakout + Exclusion
...
### Ví dụ 10 — [v5 MỚI] Macro + Price Check
...
### Ví dụ 11 — [v5 MỚI] Hybrid Strategy
